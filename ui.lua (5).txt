...
-- ZyphraxHub.Window.DropdownSelection
...
-- ZyphraxHub.Window.DropdownSelection.UICorner
ZyphraxHub["5"] = Instance.new("UICorner", ZyphraxHub["4"]);
ZyphraxHub["5"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Window.DropdownSelection.UIStroke
...
-- ZyphraxHub.Window.DropdownSelection.TopBar
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.DropShadow
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame.UICorner
ZyphraxHub["b"] = Instance.new("UICorner", ZyphraxHub["a"]);
ZyphraxHub["b"]["CornerRadius"] = UDim.new(0, 5);


-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame.UIStroke
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame.TextBox
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame.TextBox.UIPadding
ZyphraxHub["e"] = Instance.new("UIPadding", ZyphraxHub["d"]);
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.BoxFrame.Frame.ImageButton
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.Close
...
-- ZyphraxHub.Window.DropdownSelection.TopBar.Title
ZyphraxHub["11"] = Instance.new("TextLabel", ZyphraxHub["7"]);
...
-- ZyphraxHub.Window.TabButtons.Lists
...
-- ZyphraxHub.Window.TabButtons.Lists.TabButton.Bar
...
-- ZyphraxHub.Window.TabButtons.Lists.TabButton.Bar.UIGradient
ZyphraxHub["18"] = Instance.new("UIGradient", ZyphraxHub["17"]);
ZyphraxHub["18"]["Enabled"] = false;
ZyphraxHub["18"]["Rotation"] = 90;
ZyphraxHub["18"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.978, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(192, 132, 252))};


-- ZyphraxHub.Window.TabButtons.Lists.TabButton.Bar.UICorner
ZyphraxHub["19"] = Instance.new("UICorner", ZyphraxHub["17"]);
ZyphraxHub["19"]["CornerRadius"] = UDim.new(0, 100);


-- ZyphraxHub.Window.TabButtons.Lists.TabButton.ImageButton
...
-- ZyphraxHub.Window.TabButtons.Lists.TabButton.ImageButton.UIAspectRatioConstraint
ZyphraxHub["1b"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["1a"]);



-- ZyphraxHub.Window.TabButtons.Lists.TabButton.TextLabel
...
-- ZyphraxHub.Window.TabButtons.AntiCornerRight
...
-- ZyphraxHub.Window.TabButtons.Border
...
-- ZyphraxHub.Window.TopFrame.Icon
...
-- ZyphraxHub.Window.TopFrame.Icon.UIAspectRatioConstraint
ZyphraxHub["2b"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["2a"]);



-- ZyphraxHub.Window.TopFrame.TextLabel
...
-- ZyphraxHub.Window.TopFrame.Close
...
-- ZyphraxHub.Window.TopFrame.Maximize
...
-- ZyphraxHub.Window.TopFrame.Hide
...
-- ZyphraxHub.Window.Tabs.AntiCornerTop
...
-- ZyphraxHub.Window.Tabs.NoObjectFoundText
...
-- ZyphraxHub.Window.NotificationFrame
...
-- ZyphraxHub.Window.NotificationFrame.NotificationList
...
-- ZyphraxHub.Window.NotificationFrame.NotificationList.UIListLayout
...
-- ZyphraxHub.Window.NotificationFrame.NotificationList.UIPadding
...
-- ZyphraxHub.Window.DarkOverlay.UICorner
...
-- ZyphraxHub.Templates.Tab.UIListLayout
...
-- ZyphraxHub.Templates.Tab.UIPadding
...
-- ZyphraxHub.Templates.TabButton
...
-- ZyphraxHub.Templates.TabButton.ImageButton
...
-- ZyphraxHub.Templates.TabButton.ImageButton.UIAspectRatioConstraint
ZyphraxHub["48"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["47"]);



-- ZyphraxHub.Templates.TabButton.TextLabel
...
-- ZyphraxHub.Templates.TabButton.Bar
...
-- ZyphraxHub.Templates.Button.Frame.UIListLayout
...
-- ZyphraxHub.Templates.Button.Frame.UIPadding
...
-- ZyphraxHub.Templates.Button.Frame.Title
...
-- ZyphraxHub.Templates.Button.Frame.Title.ClickIcon
ZyphraxHub["52"] = Instance.new("ImageButton", ZyphraxHub["51"]);
...
-- ZyphraxHub.Templates.Button.Frame.Description
...
-- ZyphraxHub.Templates.Button.Frame.UIGradient
...
-- ZyphraxHub.Templates.Paragraph
...
-- ZyphraxHub.Templates.Paragraph.Title
...
-- ZyphraxHub.Templates.Paragraph.UIPadding
...
-- ZyphraxHub.Templates.Paragraph.UIListLayout
...
-- ZyphraxHub.Templates.Paragraph.Description
...
-- ZyphraxHub.Templates.Toggle
ZyphraxHub["60"] = Instance.new("ImageButton", ZyphraxHub["41"]);
ZyphraxHub["60"]["BorderSizePixel"] = 0;
ZyphraxHub["60"]["AutoButtonColor"] = false;
ZyphraxHub["60"]["Visible"] = false;
ZyphraxHub["60"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["60"]["Selectable"] = false;
ZyphraxHub["60"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["60"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["60"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["60"]["Name"] = [[Toggle]];
ZyphraxHub["60"]["Position"] = UDim2.new(-0.0375, 0, 0.38434, 0);


-- ZyphraxHub.Templates.Toggle.UICorner
ZyphraxHub["61"] = Instance.new("UICorner", ZyphraxHub["60"]);
ZyphraxHub["61"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.Toggle.UIStroke
ZyphraxHub["62"] = Instance.new("UIStroke", ZyphraxHub["60"]);
ZyphraxHub["62"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["62"]["Thickness"] = 1.5;
ZyphraxHub["62"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Toggle.UIPadding
ZyphraxHub["63"] = Instance.new("UIPadding", ZyphraxHub["60"]);
ZyphraxHub["63"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["63"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["63"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["63"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.Toggle.UIListLayout
ZyphraxHub["64"] = Instance.new("UIListLayout", ZyphraxHub["60"]);
ZyphraxHub["64"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["64"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Toggle.Description
ZyphraxHub["65"] = Instance.new("TextLabel", ZyphraxHub["60"]);
ZyphraxHub["65"]["TextWrapped"] = true;
ZyphraxHub["65"]["Interactable"] = false;
ZyphraxHub["65"]["BorderSizePixel"] = 0;
ZyphraxHub["65"]["TextSize"] = 16;
ZyphraxHub["65"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["65"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["65"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["65"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["65"]["BackgroundTransparency"] = 1;
ZyphraxHub["65"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["65"]["Visible"] = false;
ZyphraxHub["65"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["65"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["65"]["LayoutOrder"] = 1;
ZyphraxHub["65"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["65"]["Name"] = [[Description]];


-- ZyphraxHub.Templates.Toggle.Title
-- ZyphraxHub.Templates.Toggle.Title
ZyphraxHub["66"] = Instance.new("TextLabel", ZyphraxHub["60"]);
ZyphraxHub["66"]["TextWrapped"] = true;
ZyphraxHub["66"]["BorderSizePixel"] = 0;
ZyphraxHub["66"]["TextSize"] = 16;
ZyphraxHub["66"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["66"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["66"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["66"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["66"]["BackgroundTransparency"] = 1;
ZyphraxHub["66"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["66"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["66"]["Text"] = [[Toggle]];
ZyphraxHub["66"]["Name"] = [[Title]];


-- ZyphraxHub.Templates.Toggle.Title.Fill
ZyphraxHub["67"] = Instance.new("ImageButton", ZyphraxHub["66"]);
ZyphraxHub["67"]["BorderSizePixel"] = 0;
ZyphraxHub["67"]["AutoButtonColor"] = false;
ZyphraxHub["67"]["BackgroundColor3"] = Color3.fromRGB(54, 57, 63);
ZyphraxHub["67"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["67"]["AnchorPoint"] = Vector2.new(1, 0.5);
ZyphraxHub["67"]["Size"] = UDim2.new(0, 45, 0, 25);
ZyphraxHub["67"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["67"]["Name"] = [[Fill]];
ZyphraxHub["67"]["Position"] = UDim2.new(1, 0, 0.5, 0);


-- ZyphraxHub.Templates.Toggle.Title.Fill.UICorner
ZyphraxHub["68"] = Instance.new("UICorner", ZyphraxHub["67"]);
ZyphraxHub["68"]["CornerRadius"] = UDim.new(100, 0);


-- ZyphraxHub.Templates.Toggle.Title.Fill.Ball
ZyphraxHub["69"] = Instance.new("ImageButton", ZyphraxHub["67"]);
ZyphraxHub["69"]["Active"] = false;
ZyphraxHub["69"]["Interactable"] = false;
ZyphraxHub["69"]["BorderSizePixel"] = 0;
ZyphraxHub["69"]["AutoButtonColor"] = false;
ZyphraxHub["69"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["69"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["69"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["69"]["Size"] = UDim2.new(0, 20, 0, 20);
ZyphraxHub["69"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["69"]["Name"] = [[Ball]];
ZyphraxHub["69"]["Position"] = UDim2.new(0, 0, 0.5, 0);


-- ZyphraxHub.Templates.Toggle.Title.Fill.Ball.UICorner
ZyphraxHub["6a"] = Instance.new("UICorner", ZyphraxHub["69"]);
ZyphraxHub["6a"]["CornerRadius"] = UDim.new(100, 0);


-- ZyphraxHub.Templates.Toggle.Title.Fill.Ball.Icon
ZyphraxHub["6b"] = Instance.new("ImageLabel", ZyphraxHub["69"]);
ZyphraxHub["6b"]["BorderSizePixel"] = 0;
ZyphraxHub["6b"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["6b"]["ImageColor3"] = Color3.fromRGB(54, 57, 63);
ZyphraxHub["6b"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["6b"]["Size"] = UDim2.new(1, -5, 1, -5);
ZyphraxHub["6b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["6b"]["BackgroundTransparency"] = 1;
ZyphraxHub["6b"]["Name"] = [[Icon]];
ZyphraxHub["6b"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.Toggle.Title.Fill.UIPadding
ZyphraxHub["6c"] = Instance.new("UIPadding", ZyphraxHub["67"]);
ZyphraxHub["6c"]["PaddingTop"] = UDim.new(0, 2);
ZyphraxHub["6c"]["PaddingRight"] = UDim.new(0, 2);
ZyphraxHub["6c"]["PaddingLeft"] = UDim.new(0, 2);
ZyphraxHub["6c"]["PaddingBottom"] = UDim.new(0, 2);


-- ZyphraxHub.Templates.Notification
ZyphraxHub["6d"] = Instance.new("Frame", ZyphraxHub["41"]);
ZyphraxHub["6d"]["Visible"] = false;
ZyphraxHub["6d"]["BorderSizePixel"] = 0;
ZyphraxHub["6d"]["BackgroundColor3"] = Color3.fromRGB(37, 40, 47);
ZyphraxHub["6d"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["6d"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["6d"]["Size"] = UDim2.new(1, 0, 0, 65);
ZyphraxHub["6d"]["Position"] = UDim2.new(0.8244, 0, 0.88221, 0);
ZyphraxHub["6d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["6d"]["Name"] = [[Notification]];
ZyphraxHub["6d"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.Notification.Items
ZyphraxHub["6e"] = Instance.new("CanvasGroup", ZyphraxHub["6d"]);
ZyphraxHub["6e"]["ZIndex"] = 2;
ZyphraxHub["6e"]["BorderSizePixel"] = 0;
ZyphraxHub["6e"]["BackgroundColor3"] = Color3.fromRGB(37, 40, 47);
ZyphraxHub["6e"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["6e"]["Size"] = UDim2.new(0, 265, 0, 70);
ZyphraxHub["6e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["6e"]["Name"] = [[Items]];


-- ZyphraxHub.Templates.Notification.Items.Frame
ZyphraxHub["6f"] = Instance.new("Frame", ZyphraxHub["6e"]);
ZyphraxHub["6f"]["BorderSizePixel"] = 0;
ZyphraxHub["6f"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["6f"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["6f"]["Size"] = UDim2.new(0, 265, 0, 70);
ZyphraxHub["6f"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["6f"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.Notification.Items.Frame.UIListLayout
ZyphraxHub["70"] = Instance.new("UIListLayout", ZyphraxHub["6f"]);
ZyphraxHub["70"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["70"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["70"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Notification.Items.Frame.UIPadding
ZyphraxHub["71"] = Instance.new("UIPadding", ZyphraxHub["6f"]);
ZyphraxHub["71"]["PaddingTop"] = UDim.new(0, 15);
ZyphraxHub["71"]["PaddingLeft"] = UDim.new(0, 15);
ZyphraxHub["71"]["PaddingBottom"] = UDim.new(0, 15);
...
-- ZyphraxHub.Templates.Notification.Items.Frame.SubContent
ZyphraxHub["72"] = Instance.new("TextLabel", ZyphraxHub["6f"]);
ZyphraxHub["72"]["TextWrapped"] = true;
ZyphraxHub["72"]["BorderSizePixel"] = 0;
ZyphraxHub["72"]["TextSize"] = 12;
ZyphraxHub["72"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["72"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["72"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
ZyphraxHub["72"]["TextColor3"] = Color3.fromRGB(181, 181, 181);
ZyphraxHub["72"]["BackgroundTransparency"] = 1;
ZyphraxHub["72"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["72"]["Size"] = UDim2.new(0, 218, 0, 10);
ZyphraxHub["72"]["Visible"] = false;
ZyphraxHub["72"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["72"]["Text"] = [[This is a notification]];
ZyphraxHub["72"]["LayoutOrder"] = 1;
ZyphraxHub["72"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["72"]["Name"] = [[SubContent]];
ZyphraxHub["72"]["Position"] = UDim2.new(0, 0, 0, 19);


-- ZyphraxHub.Templates.Notification.Items.Frame.SubContent.UIGradient
ZyphraxHub["73"] = Instance.new("UIGradient", ZyphraxHub["72"]);
ZyphraxHub["73"]["Enabled"] = false;
ZyphraxHub["73"]["Rotation"] = -90;
ZyphraxHub["73"]["Color"] = ColorSequence.new{ ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)), ColorSequenceKeypoint.new(1.000, Color3.fromRGB(192, 132, 252)) };

-- ZyphraxHub.Templates.Notification.Items.Frame.Title
ZyphraxHub["74"] = Instance.new("TextLabel", ZyphraxHub["6f"]);
ZyphraxHub["74"]["TextWrapped"] = true;
ZyphraxHub["74"]["BorderSizePixel"] = 0;
ZyphraxHub["74"]["TextSize"] = 16;
ZyphraxHub["74"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["74"]["TextScaled"] = true;
ZyphraxHub["74"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["74"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["74"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["74"]["BackgroundTransparency"] = 1;
ZyphraxHub["74"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["74"]["Size"] = UDim2.new(0, 235, 0, 18);
ZyphraxHub["74"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["74"]["Text"] = [[Title]];
ZyphraxHub["74"]["Name"] = [[Title]];
ZyphraxHub["74"]["Position"] = UDim2.new(0, 0, 0, 9);


-- ZyphraxHub.Templates.Notification.Items.Frame.Title.Close
ZyphraxHub["75"] = Instance.new("ImageButton", ZyphraxHub["74"]);
ZyphraxHub["75"]["BorderSizePixel"] = 0;
ZyphraxHub["75"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["75"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["75"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["75"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["75"]["Image"] = [[rbxassetid://132453323679056]];
ZyphraxHub["75"]["Size"] = UDim2.new(0.09706, 0, 1.33333, 0);
ZyphraxHub["75"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["75"]["Name"] = [[Close]];
ZyphraxHub["75"]["Position"] = UDim2.new(0.92, 0, 0.5, 0);


-- ZyphraxHub.Templates.Notification.Items.Frame.Title.Close.UIAspectRatioConstraint
ZyphraxHub["76"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["75"]);



-- ZyphraxHub.Templates.Notification.Items.Frame.Title.UIPadding
ZyphraxHub["77"] = Instance.new("UIPadding", ZyphraxHub["74"]);
ZyphraxHub["77"]["PaddingLeft"] = UDim.new(0, 30);


-- ZyphraxHub.Templates.Notification.Items.Frame.Title.Icon
ZyphraxHub["78"] = Instance.new("ImageButton", ZyphraxHub["74"]);
ZyphraxHub["78"]["BorderSizePixel"] = 0;
ZyphraxHub["78"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["78"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["78"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["78"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["78"]["Image"] = [[rbxassetid://92049322344253]];
ZyphraxHub["78"]["Size"] = UDim2.new(0.09706, 0, 1.33333, 0);
ZyphraxHub["78"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["78"]["Name"] = [[Icon]];
ZyphraxHub["78"]["Position"] = UDim2.new(0, -30, 0.5, 0);


-- ZyphraxHub.Templates.Notification.Items.Frame.Title.Icon.UIAspectRatioConstraint
ZyphraxHub["79"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["78"]);



-- ZyphraxHub.Templates.Notification.Items.Frame.Content
ZyphraxHub["7a"] = Instance.new("TextLabel", ZyphraxHub["6f"]);
ZyphraxHub["7a"]["TextWrapped"] = true;
ZyphraxHub["7a"]["BorderSizePixel"] = 0;
ZyphraxHub["7a"]["TextSize"] = 16;
ZyphraxHub["7a"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["7a"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["7a"]["FontFace"] = Font.new([[rbxasset://fonts/families/GothamSSm.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["7a"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["7a"]["BackgroundTransparency"] = 1;
ZyphraxHub["7a"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["7a"]["Size"] = UDim2.new(0, 218, 0, 10);
ZyphraxHub["7a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["7a"]["Text"] = [[Content]];
ZyphraxHub["7a"]["LayoutOrder"] = 2;
ZyphraxHub["7a"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["7a"]["Name"] = [[Content]];
ZyphraxHub["7a"]["Position"] = UDim2.new(0, 0, 0, 19);

-- ZyphraxHub.Templates.Notification.Items.Frame.Content.UIGradient
ZyphraxHub["7b"] = Instance.new("UIGradient", ZyphraxHub["7a"]);
ZyphraxHub["7b"]["Enabled"] = false;
ZyphraxHub["7b"]["Rotation"] = -90;
ZyphraxHub["7b"]["Color"] = ColorSequence.new{
    ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),
    ColorSequenceKeypoint.new(1.000, Color3.fromRGB(192, 132, 252))
};

-- ZyphraxHub.Templates.Notification.Items.TimerBarFill
ZyphraxHub["7c"] = Instance.new("Frame", ZyphraxHub["6e"]);
ZyphraxHub["7c"]["BorderSizePixel"] = 0;
ZyphraxHub["7c"]["BackgroundColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["7c"]["AnchorPoint"] = Vector2.new(0, 1);
ZyphraxHub["7c"]["Size"] = UDim2.new(1, 0, 0, 5);
ZyphraxHub["7c"]["Position"] = UDim2.new(0, 0, 1, 0);
ZyphraxHub["7c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["7c"]["Name"] = [[TimerBarFill]];
ZyphraxHub["7c"]["BackgroundTransparency"] = 0.7;

-- ZyphraxHub.Templates.Notification.Items.TimerBarFill.UICorner
ZyphraxHub["7d"] = Instance.new("UICorner", ZyphraxHub["7c"]);

-- ZyphraxHub.Templates.Notification.Items.TimerBarFill.Bar
ZyphraxHub["7e"] = Instance.new("Frame", ZyphraxHub["7c"]);
ZyphraxHub["7e"]["BorderSizePixel"] = 0;
ZyphraxHub["7e"]["BackgroundColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["7e"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["7e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["7e"]["Name"] = [[Bar]];

-- ZyphraxHub.Templates.Notification.Items.TimerBarFill.Bar.UICorner
ZyphraxHub["7f"] = Instance.new("UICorner", ZyphraxHub["7e"]);

-- ZyphraxHub.Templates.Notification.Items.UIStroke
ZyphraxHub["80"] = Instance.new("UIStroke", ZyphraxHub["6e"]);
ZyphraxHub["80"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["80"]["Thickness"] = 1.5;
ZyphraxHub["80"]["Color"] = Color3.fromRGB(61, 61, 75);

-- ZyphraxHub.Templates.Notification.Items.UICorner
ZyphraxHub["81"] = Instance.new("UICorner", ZyphraxHub["6e"]);

-- ZyphraxHub.Templates.Slider
ZyphraxHub["82"] = Instance.new("Frame", ZyphraxHub["41"]);
ZyphraxHub["82"]["Visible"] = false;
ZyphraxHub["82"]["BorderSizePixel"] = 0;
ZyphraxHub["82"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["82"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["82"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["82"]["Position"] = UDim2.new(-0.0375, 0, 0.38434, 0);
ZyphraxHub["82"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["82"]["Name"] = [[Slider]];


-- ZyphraxHub.Templates.Slider.UICorner
ZyphraxHub["83"] = Instance.new("UICorner", ZyphraxHub["82"]);
ZyphraxHub["83"]["CornerRadius"] = UDim.new(0, 6);

-- ZyphraxHub.Templates.Slider.UIStroke
ZyphraxHub["84"] = Instance.new("UIStroke", ZyphraxHub["82"]);
ZyphraxHub["84"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["84"]["Thickness"] = 1.5;
ZyphraxHub["84"]["Color"] = Color3.fromRGB(61, 61, 75);

-- ZyphraxHub.Templates.Slider.Title
ZyphraxHub["85"] = Instance.new("TextLabel", ZyphraxHub["82"]);
ZyphraxHub["85"]["TextWrapped"] = true;
ZyphraxHub["85"]["Interactable"] = false;
ZyphraxHub["85"]["BorderSizePixel"] = 0;
ZyphraxHub["85"]["TextSize"] = 16;
ZyphraxHub["85"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["85"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["85"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["85"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["85"]["BackgroundTransparency"] = 1;
ZyphraxHub["85"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["85"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["85"]["Text"] = [[Slider]];
ZyphraxHub["85"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["85"]["Name"] = [[Title]];

-- ZyphraxHub.Templates.Slider.UIPadding
ZyphraxHub["86"] = Instance.new("UIPadding", ZyphraxHub["82"]);
ZyphraxHub["86"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["86"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["86"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["86"]["PaddingBottom"] = UDim.new(0, 10);

-- ZyphraxHub.Templates.Slider.UIListLayout
ZyphraxHub["87"] = Instance.new("UIListLayout", ZyphraxHub["82"]);
ZyphraxHub["87"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["87"]["SortOrder"] = Enum.SortOrder.LayoutOrder;

-- ZyphraxHub.Templates.Slider.Description
ZyphraxHub["88"] = Instance.new("TextLabel", ZyphraxHub["82"]);
ZyphraxHub["88"]["TextWrapped"] = true;
ZyphraxHub["88"]["Interactable"] = false;
ZyphraxHub["88"]["BorderSizePixel"] = 0;
ZyphraxHub["88"]["TextSize"] = 16;
ZyphraxHub["88"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["88"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["88"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["88"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["88"]["BackgroundTransparency"] = 1;
ZyphraxHub["88"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["88"]["Visible"] = false;
ZyphraxHub["88"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["88"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["88"]["LayoutOrder"] = 1;
ZyphraxHub["88"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["88"]["Name"] = [[Description]];

-- ZyphraxHub.Templates.Slider.SliderFrame
ZyphraxHub["89"] = Instance.new("Frame", ZyphraxHub["82"]);
ZyphraxHub["89"]["ZIndex"] = 0;
ZyphraxHub["89"]["BorderSizePixel"] = 0;
ZyphraxHub["89"]["Size"] = UDim2.new(1, 0, 0, 25);
ZyphraxHub["89"]["Name"] = [[SliderFrame]];
ZyphraxHub["89"]["LayoutOrder"] = 2;
ZyphraxHub["89"]["BackgroundTransparency"] = 1;

-- ZyphraxHub.Templates.Slider.SliderFrame.Frame
ZyphraxHub["8a"] = Instance.new("Frame", ZyphraxHub["89"]);
ZyphraxHub["8a"]["ZIndex"] = 0;
ZyphraxHub["8a"]["BorderSizePixel"] = 0;
ZyphraxHub["8a"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["8a"]["Size"] = UDim2.new(1, 0, 0, 20);
ZyphraxHub["8a"]["Position"] = UDim2.new(0, 0, 0.5, 0);
ZyphraxHub["8a"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.DropShadow
ZyphraxHub["8b"] = Instance.new("ImageLabel", ZyphraxHub["8a"]);
ZyphraxHub["8b"]["ZIndex"] = 0;
ZyphraxHub["8b"]["BorderSizePixel"] = 0;
ZyphraxHub["8b"]["SliceCenter"] = Rect.new(49, 49, 450, 450);
ZyphraxHub["8b"]["ScaleType"] = Enum.ScaleType.Slice;
ZyphraxHub["8b"]["ImageTransparency"] = 0.75;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["8b"]["ImageColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["8b"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["8b"]["Image"] = [[rbxassetid://6014261993]];
ZyphraxHub["8b"]["Size"] = UDim2.new(1, 25, 1, 25);
ZyphraxHub["8b"]["BackgroundTransparency"] = 1;
ZyphraxHub["8b"]["Name"] = [[DropShadow]];
ZyphraxHub["8b"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider
ZyphraxHub["8c"] = Instance.new("CanvasGroup", ZyphraxHub["8a"]);
ZyphraxHub["8c"]["BorderSizePixel"] = 0;
ZyphraxHub["8c"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["8c"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["8c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["8c"]["Name"] = [[Slider]];


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.UICorner
ZyphraxHub["8d"] = Instance.new("UICorner", ZyphraxHub["8c"]);
ZyphraxHub["8d"]["CornerRadius"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.UIStroke
ZyphraxHub["8e"] = Instance.new("UIStroke", ZyphraxHub["8c"]);
ZyphraxHub["8e"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["8e"]["Thickness"] = 1.5;
ZyphraxHub["8e"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.UIPadding
ZyphraxHub["8f"] = Instance.new("UIPadding", ZyphraxHub["8c"]);
ZyphraxHub["8f"]["PaddingTop"] = UDim.new(0, 2);
ZyphraxHub["8f"]["PaddingRight"] = UDim.new(0, 2);
ZyphraxHub["8f"]["PaddingLeft"] = UDim.new(0, 2);
ZyphraxHub["8f"]["PaddingBottom"] = UDim.new(0, 2);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Trigger
ZyphraxHub["90"] = Instance.new("TextButton", ZyphraxHub["8c"]);
ZyphraxHub["90"]["BorderSizePixel"] = 0;
ZyphraxHub["90"]["TextSize"] = 14;
ZyphraxHub["90"]["AutoButtonColor"] = false;
ZyphraxHub["90"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["90"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["90"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
ZyphraxHub["90"]["BackgroundTransparency"] = 1;
ZyphraxHub["90"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["90"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["90"]["Text"] = [[]];
ZyphraxHub["90"]["Name"] = [[Trigger]];


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill
ZyphraxHub["91"] = Instance.new("ImageButton", ZyphraxHub["8c"]);
ZyphraxHub["91"]["Active"] = false;
ZyphraxHub["91"]["Interactable"] = false;
ZyphraxHub["91"]["BorderSizePixel"] = 0;
ZyphraxHub["91"]["AutoButtonColor"] = false;
ZyphraxHub["91"]["BackgroundTransparency"] = 1;
ZyphraxHub["91"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["91"]["Selectable"] = false;
ZyphraxHub["91"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["91"]["Size"] = UDim2.new(0, 0, 1, 0);
ZyphraxHub["91"]["ClipsDescendants"] = true;
ZyphraxHub["91"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["91"]["Name"] = [[Fill]];
ZyphraxHub["91"]["Position"] = UDim2.new(0, 0, 0.5, 0);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.UICorner
ZyphraxHub["92"] = Instance.new("UICorner", ZyphraxHub["91"]);
ZyphraxHub["92"]["CornerRadius"] = UDim.new(0, 4);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.UIStroke
ZyphraxHub["93"] = Instance.new("UIStroke", ZyphraxHub["91"]);
ZyphraxHub["93"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["93"]["Thickness"] = 1.5;
ZyphraxHub["93"]["Color"] = Color3.fromRGB(124, 58, 237);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.BackgroundGradient
ZyphraxHub["94"] = Instance.new("ImageButton", ZyphraxHub["91"]);
ZyphraxHub["94"]["Active"] = false;
ZyphraxHub["94"]["Interactable"] = false;
ZyphraxHub["94"]["BorderSizePixel"] = 0;
ZyphraxHub["94"]["AutoButtonColor"] = false;
ZyphraxHub["94"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["94"]["Selectable"] = false;
ZyphraxHub["94"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["94"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["94"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["94"]["Name"] = [[BackgroundGradient]];
ZyphraxHub["94"]["Position"] = UDim2.new(0, 0, 0.5, 0);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.BackgroundGradient.UICorner
ZyphraxHub["95"] = Instance.new("UICorner", ZyphraxHub["94"]);
ZyphraxHub["95"]["CornerRadius"] = UDim.new(0, 4);


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.BackgroundGradient.UIGradient
ZyphraxHub["96"] = Instance.new("UIGradient", ZyphraxHub["94"]);
ZyphraxHub["96"]["Enabled"] = false;
ZyphraxHub["96"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.BackgroundGradient.UIGradient
ZyphraxHub["97"] = Instance.new("UIGradient", ZyphraxHub["94"]);
ZyphraxHub["97"]["Enabled"] = false;
ZyphraxHub["97"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.Slider.Fill.BackgroundGradient.UIGradient
ZyphraxHub["98"] = Instance.new("UIGradient", ZyphraxHub["94"]);
ZyphraxHub["98"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Slider.SliderFrame.Frame.ValueText
ZyphraxHub["99"] = Instance.new("TextLabel", ZyphraxHub["8a"]);
ZyphraxHub["99"]["TextWrapped"] = true;
ZyphraxHub["99"]["Interactable"] = false;
ZyphraxHub["99"]["ZIndex"] = 2;
ZyphraxHub["99"]["BorderSizePixel"] = 0;
ZyphraxHub["99"]["TextSize"] = 14;
ZyphraxHub["99"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["99"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["99"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["99"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["99"]["BackgroundTransparency"] = 1;
ZyphraxHub["99"]["RichText"] = true;
ZyphraxHub["99"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["99"]["Size"] = UDim2.new(1, -15, 1, 0);
ZyphraxHub["99"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["99"]["Text"] = [[0]];
ZyphraxHub["99"]["Name"] = [[ValueText]];
ZyphraxHub["99"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.TextBox
ZyphraxHub["9a"] = Instance.new("Frame", ZyphraxHub["41"]);
ZyphraxHub["9a"]["Visible"] = false;
ZyphraxHub["9a"]["BorderSizePixel"] = 0;
ZyphraxHub["9a"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["9a"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["9a"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["9a"]["Position"] = UDim2.new(-0.0375, 0, 0.38434, 0);
ZyphraxHub["9a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["9a"]["Name"] = [[TextBox]];


-- ZyphraxHub.Templates.TextBox.UICorner
ZyphraxHub["9b"] = Instance.new("UICorner", ZyphraxHub["9a"]);
ZyphraxHub["9b"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.TextBox.UIStroke
ZyphraxHub["9c"] = Instance.new("UIStroke", ZyphraxHub["9a"]);
ZyphraxHub["9c"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["9c"]["Thickness"] = 1.5;
ZyphraxHub["9c"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.TextBox.Title
ZyphraxHub["9d"] = Instance.new("TextLabel", ZyphraxHub["9a"]);
ZyphraxHub["9d"]["TextWrapped"] = true;
ZyphraxHub["9d"]["Interactable"] = false;
ZyphraxHub["9d"]["BorderSizePixel"] = 0;
ZyphraxHub["9d"]["TextSize"] = 16;
ZyphraxHub["9d"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["9d"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["9d"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["9d"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["9d"]["BackgroundTransparency"] = 1;
ZyphraxHub["9d"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["9d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["9d"]["Text"] = [[Input Textbox]];
ZyphraxHub["9d"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["9d"]["Name"] = [[Title]];


-- ZyphraxHub.Templates.TextBox.UIPadding
ZyphraxHub["9e"] = Instance.new("UIPadding", ZyphraxHub["9a"]);
ZyphraxHub["9e"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["9e"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["9e"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["9e"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.TextBox.UIListLayout
ZyphraxHub["9f"] = Instance.new("UIListLayout", ZyphraxHub["9a"]);
ZyphraxHub["9f"]["Padding"] = UDim.new(0, 10);
ZyphraxHub["9f"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.TextBox.Description
ZyphraxHub["a0"] = Instance.new("TextLabel", ZyphraxHub["9a"]);
ZyphraxHub["a0"]["TextWrapped"] = true;
ZyphraxHub["a0"]["Interactable"] = false;
ZyphraxHub["a0"]["BorderSizePixel"] = 0;
ZyphraxHub["a0"]["TextSize"] = 16;
ZyphraxHub["a0"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["a0"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["a0"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["a0"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["a0"]["BackgroundTransparency"] = 1;
ZyphraxHub["a0"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["a0"]["Visible"] = false;
ZyphraxHub["a0"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["a0"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["a0"]["LayoutOrder"] = 1;
ZyphraxHub["a0"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["a0"]["Name"] = [[Description]];


-- ZyphraxHub.Templates.TextBox.BoxFrame
ZyphraxHub["a1"] = Instance.new("Frame", ZyphraxHub["9a"]);
ZyphraxHub["a1"]["ZIndex"] = 0;
ZyphraxHub["a1"]["BorderSizePixel"] = 0;
ZyphraxHub["a1"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["a1"]["Size"] = UDim2.new(1, 0, 0, 25);
ZyphraxHub["a1"]["Name"] = [[BoxFrame]];
ZyphraxHub["a1"]["LayoutOrder"] = 2;
ZyphraxHub["a1"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.TextBox.BoxFrame.DropShadow
ZyphraxHub["a2"] = Instance.new("ImageLabel", ZyphraxHub["a1"]);
ZyphraxHub["a2"]["ZIndex"] = 0;
ZyphraxHub["a2"]["BorderSizePixel"] = 0;
ZyphraxHub["a2"]["SliceCenter"] = Rect.new(49, 49, 450, 450);
ZyphraxHub["a2"]["ScaleType"] = Enum.ScaleType.Slice;
ZyphraxHub["a2"]["ImageTransparency"] = 0.75;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["a2"]["ImageColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["a2"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["a2"]["Image"] = [[rbxassetid://6014261993]];
ZyphraxHub["a2"]["Size"] = UDim2.new(1, 35, 1, 30);
ZyphraxHub["a2"]["BackgroundTransparency"] = 1;
ZyphraxHub["a2"]["Name"] = [[DropShadow]];
ZyphraxHub["a2"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame
ZyphraxHub["a3"] = Instance.new("Frame", ZyphraxHub["a1"]);
ZyphraxHub["a3"]["BorderSizePixel"] = 0;
ZyphraxHub["a3"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["a3"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["a3"]["Size"] = UDim2.new(1, 0, 0, 25);
ZyphraxHub["a3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame.UICorner
ZyphraxHub["a4"] = Instance.new("UICorner", ZyphraxHub["a3"]);
ZyphraxHub["a4"]["CornerRadius"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame.UIStroke
ZyphraxHub["a5"] = Instance.new("UIStroke", ZyphraxHub["a3"]);
ZyphraxHub["a5"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["a5"]["Thickness"] = 1.5;
ZyphraxHub["a5"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame.UIListLayout
ZyphraxHub["a6"] = Instance.new("UIListLayout", ZyphraxHub["a3"]);
ZyphraxHub["a6"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
ZyphraxHub["a6"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["a6"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["a6"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame.TextBox
ZyphraxHub["a7"] = Instance.new("TextBox", ZyphraxHub["a3"]);
ZyphraxHub["a7"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["a7"]["PlaceholderColor3"] = Color3.fromRGB(140, 140, 140);
ZyphraxHub["a7"]["BorderSizePixel"] = 0;
ZyphraxHub["a7"]["TextWrapped"] = true;
ZyphraxHub["a7"]["TextTruncate"] = Enum.TextTruncate.AtEnd;
ZyphraxHub["a7"]["TextSize"] = 14;
ZyphraxHub["a7"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["a7"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["a7"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["a7"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["a7"]["ClipsDescendants"] = true;
ZyphraxHub["a7"]["PlaceholderText"] = [[Input here...]];
ZyphraxHub["a7"]["Size"] = UDim2.new(1, 0, 0, 25);
ZyphraxHub["a7"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["a7"]["Text"] = [[]];
ZyphraxHub["a7"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.TextBox.BoxFrame.Frame.TextBox.UIPadding
ZyphraxHub["a8"] = Instance.new("UIPadding", ZyphraxHub["a7"]);
ZyphraxHub["a8"]["PaddingTop"] = UDim.new(0, 5);
ZyphraxHub["a8"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["a8"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["a8"]["PaddingBottom"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.Dropdown
ZyphraxHub["a9"] = Instance.new("ImageButton", ZyphraxHub["41"]);
ZyphraxHub["a9"]["BorderSizePixel"] = 0;
ZyphraxHub["a9"]["AutoButtonColor"] = false;
ZyphraxHub["a9"]["Visible"] = false;
ZyphraxHub["a9"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["a9"]["Selectable"] = false;
ZyphraxHub["a9"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["a9"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["a9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["a9"]["Name"] = [[Dropdown]];
ZyphraxHub["a9"]["Position"] = UDim2.new(-0.0375, 0, 0.38434, 0);


-- ZyphraxHub.Templates.Dropdown.UICorner
ZyphraxHub["aa"] = Instance.new("UICorner", ZyphraxHub["a9"]);
ZyphraxHub["aa"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.Dropdown.UIStroke
ZyphraxHub["ab"] = Instance.new("UIStroke", ZyphraxHub["a9"]);
ZyphraxHub["ab"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["ab"]["Thickness"] = 1.5;
ZyphraxHub["ab"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Dropdown.Title
ZyphraxHub["ac"] = Instance.new("TextLabel", ZyphraxHub["a9"]);
ZyphraxHub["ac"]["TextWrapped"] = true;
ZyphraxHub["ac"]["BorderSizePixel"] = 0;
ZyphraxHub["ac"]["TextSize"] = 16;
ZyphraxHub["ac"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["ac"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["ac"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["ac"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["ac"]["BackgroundTransparency"] = 1;
ZyphraxHub["ac"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["ac"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["ac"]["Text"] = [[Dropdown]];
ZyphraxHub["ac"]["Name"] = [[Title]];
ZyphraxHub["ac"]["Position"] = UDim2.new(0.03135, 0, 0, 0);


-- ZyphraxHub.Templates.Dropdown.Title.ClickIcon
ZyphraxHub["ad"] = Instance.new("ImageButton", ZyphraxHub["ac"]);
ZyphraxHub["ad"]["BorderSizePixel"] = 0;
ZyphraxHub["ad"]["AutoButtonColor"] = false;
ZyphraxHub["ad"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["ad"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["ad"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["ad"]["AnchorPoint"] = Vector2.new(1, 0.5);
ZyphraxHub["ad"]["Image"] = [[rbxassetid://77563793724007]];
ZyphraxHub["ad"]["Size"] = UDim2.new(0, 23, 0, 23);
ZyphraxHub["ad"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["ad"]["Name"] = [[ClickIcon]];
ZyphraxHub["ad"]["Position"] = UDim2.new(1, 0, 0.5, 0);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame
ZyphraxHub["ae"] = Instance.new("ImageButton", ZyphraxHub["ac"]);
ZyphraxHub["ae"]["Active"] = false;
ZyphraxHub["ae"]["BorderSizePixel"] = 0;
ZyphraxHub["ae"]["BackgroundTransparency"] = 1;
ZyphraxHub["ae"]["Selectable"] = false;
ZyphraxHub["ae"]["ZIndex"] = 0;
ZyphraxHub["ae"]["AnchorPoint"] = Vector2.new(1, 0.5);
ZyphraxHub["ae"]["AutomaticSize"] = Enum.AutomaticSize.X;
ZyphraxHub["ae"]["Size"] = UDim2.new(0, 20, 0, 20);
ZyphraxHub["ae"]["Name"] = [[BoxFrame]];
ZyphraxHub["ae"]["Position"] = UDim2.new(1, -33, 0.5, 0);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.DropShadow
ZyphraxHub["af"] = Instance.new("ImageLabel", ZyphraxHub["ae"]);
ZyphraxHub["af"]["Interactable"] = false;
ZyphraxHub["af"]["ZIndex"] = 0;
ZyphraxHub["af"]["BorderSizePixel"] = 0;
ZyphraxHub["af"]["SliceCenter"] = Rect.new(49, 49, 450, 450);
ZyphraxHub["af"]["ScaleType"] = Enum.ScaleType.Slice;
ZyphraxHub["af"]["ImageTransparency"] = 0.75;
ZyphraxHub["af"]["AutomaticSize"] = Enum.AutomaticSize.X;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["af"]["ImageColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["af"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["af"]["Image"] = [[rbxassetid://6014261993]];
ZyphraxHub["af"]["Size"] = UDim2.new(1, 28, 1, 28);
ZyphraxHub["af"]["Visible"] = false;
ZyphraxHub["af"]["BackgroundTransparency"] = 1;
ZyphraxHub["af"]["Name"] = [[DropShadow]];
ZyphraxHub["af"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger
ZyphraxHub["b0"] = Instance.new("ImageButton", ZyphraxHub["ae"]);
ZyphraxHub["b0"]["BorderSizePixel"] = 0;
ZyphraxHub["b0"]["AutoButtonColor"] = false;
ZyphraxHub["b0"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["b0"]["Selectable"] = false;
ZyphraxHub["b0"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["b0"]["AutomaticSize"] = Enum.AutomaticSize.X;
ZyphraxHub["b0"]["Size"] = UDim2.new(0, 20, 0, 20);
ZyphraxHub["b0"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["b0"]["Name"] = [[Trigger]];
ZyphraxHub["b0"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger.UICorner
ZyphraxHub["b1"] = Instance.new("UICorner", ZyphraxHub["b0"]);
ZyphraxHub["b1"]["CornerRadius"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger.UIStroke
ZyphraxHub["b2"] = Instance.new("UIStroke", ZyphraxHub["b0"]);
ZyphraxHub["b2"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["b2"]["Thickness"] = 1.5;
ZyphraxHub["b2"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger.UIListLayout
ZyphraxHub["b3"] = Instance.new("UIListLayout", ZyphraxHub["b0"]);
ZyphraxHub["b3"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["b3"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["b3"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger.Title
ZyphraxHub["b4"] = Instance.new("TextLabel", ZyphraxHub["b0"]);
ZyphraxHub["b4"]["TextWrapped"] = true;
ZyphraxHub["b4"]["Interactable"] = false;
ZyphraxHub["b4"]["BorderSizePixel"] = 0;
ZyphraxHub["b4"]["TextSize"] = 16;
ZyphraxHub["b4"]["TextScaled"] = true;
ZyphraxHub["b4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["b4"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["b4"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["b4"]["BackgroundTransparency"] = 1;
ZyphraxHub["b4"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["b4"]["Size"] = UDim2.new(0, 15, 0, 14);
ZyphraxHub["b4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["b4"]["Text"] = [[]];
ZyphraxHub["b4"]["AutomaticSize"] = Enum.AutomaticSize.X;
ZyphraxHub["b4"]["Name"] = [[Title]];
ZyphraxHub["b4"]["Position"] = UDim2.new(-0.00345, 0, 0.5, 0);


-- ZyphraxHub.Templates.Dropdown.Title.BoxFrame.Trigger.UIPadding
ZyphraxHub["b5"] = Instance.new("UIPadding", ZyphraxHub["b0"]);
ZyphraxHub["b5"]["PaddingRight"] = UDim.new(0, 5);
ZyphraxHub["b5"]["PaddingLeft"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.Dropdown.UIPadding
ZyphraxHub["b6"] = Instance.new("UIPadding", ZyphraxHub["a9"]);
ZyphraxHub["b6"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["b6"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["b6"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["b6"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.Dropdown.UIListLayout
ZyphraxHub["b7"] = Instance.new("UIListLayout", ZyphraxHub["a9"]);
ZyphraxHub["b7"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["b7"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Dropdown.Description
ZyphraxHub["b8"] = Instance.new("TextLabel", ZyphraxHub["a9"]);
ZyphraxHub["b8"]["TextWrapped"] = true;
ZyphraxHub["b8"]["Interactable"] = false;
ZyphraxHub["b8"]["BorderSizePixel"] = 0;
ZyphraxHub["b8"]["TextSize"] = 16;
ZyphraxHub["b8"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["b8"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["b8"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["b8"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["b8"]["BackgroundTransparency"] = 1;
ZyphraxHub["b8"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["b8"]["Visible"] = false;
ZyphraxHub["b8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["b8"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["b8"]["LayoutOrder"] = 1;
ZyphraxHub["b8"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["b8"]["Name"] = [[Description]];


-- ZyphraxHub.Templates.Dropdown.UIGradient
ZyphraxHub["b9"] = Instance.new("UIGradient", ZyphraxHub["a9"]);
ZyphraxHub["b9"]["Enabled"] = false;
ZyphraxHub["b9"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Dropdown.UIGradient
ZyphraxHub["ba"] = Instance.new("UIGradient", ZyphraxHub["a9"]);
ZyphraxHub["ba"]["Enabled"] = false;
ZyphraxHub["ba"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Dropdown.UIGradient
ZyphraxHub["bb"] = Instance.new("UIGradient", ZyphraxHub["a9"]);
ZyphraxHub["bb"]["Enabled"] = false;
ZyphraxHub["bb"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.DropdownList
ZyphraxHub["bc"] = Instance.new("Folder", ZyphraxHub["41"]);
ZyphraxHub["bc"]["Name"] = [[DropdownList]];


-- ZyphraxHub.Templates.DropdownList.DropdownItems
ZyphraxHub["bd"] = Instance.new("ScrollingFrame", ZyphraxHub["bc"]);
ZyphraxHub["bd"]["Visible"] = false;
ZyphraxHub["bd"]["Active"] = true;
ZyphraxHub["bd"]["ScrollingDirection"] = Enum.ScrollingDirection.Y;
ZyphraxHub["bd"]["BorderSizePixel"] = 0;
ZyphraxHub["bd"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
ZyphraxHub["bd"]["ElasticBehavior"] = Enum.ElasticBehavior.Never;
ZyphraxHub["bd"]["TopImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
ZyphraxHub["bd"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["bd"]["Name"] = [[DropdownItems]];
ZyphraxHub["bd"]["Selectable"] = false;
ZyphraxHub["bd"]["BottomImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
ZyphraxHub["bd"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["bd"]["Size"] = UDim2.new(1, 0, 1, -50);
ZyphraxHub["bd"]["ScrollBarImageColor3"] = Color3.fromRGB(99, 106, 122);
ZyphraxHub["bd"]["Position"] = UDim2.new(0, 0, 0, 50);
ZyphraxHub["bd"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["bd"]["ScrollBarThickness"] = 5;
ZyphraxHub["bd"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DropdownList.DropdownItems.UIListLayout
ZyphraxHub["be"] = Instance.new("UIListLayout", ZyphraxHub["bd"]);
ZyphraxHub["be"]["Padding"] = UDim.new(0, 15);
ZyphraxHub["be"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DropdownList.DropdownItems.UIPadding
ZyphraxHub["bf"] = Instance.new("UIPadding", ZyphraxHub["bd"]);
ZyphraxHub["bf"]["PaddingTop"] = UDim.new(0, 2);
ZyphraxHub["bf"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["bf"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["bf"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DropdownList.DropdownItemsSearch
ZyphraxHub["c0"] = Instance.new("ScrollingFrame", ZyphraxHub["bc"]);
ZyphraxHub["c0"]["Visible"] = false;
ZyphraxHub["c0"]["Active"] = true;
ZyphraxHub["c0"]["ScrollingDirection"] = Enum.ScrollingDirection.Y;
ZyphraxHub["c0"]["BorderSizePixel"] = 0;
ZyphraxHub["c0"]["CanvasSize"] = UDim2.new(0, 0, 0, 0);
ZyphraxHub["c0"]["ElasticBehavior"] = Enum.ElasticBehavior.Never;
ZyphraxHub["c0"]["TopImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
ZyphraxHub["c0"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["c0"]["Name"] = [[DropdownItemsSearch]];
ZyphraxHub["c0"]["Selectable"] = false;
ZyphraxHub["c0"]["BottomImage"] = [[rbxasset://textures/ui/Scroll/scroll-middle.png]];
ZyphraxHub["c0"]["AutomaticCanvasSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["c0"]["Size"] = UDim2.new(1, 0, 1, -50);
ZyphraxHub["c0"]["ScrollBarImageColor3"] = Color3.fromRGB(99, 106, 122);
ZyphraxHub["c0"]["Position"] = UDim2.new(0, 0, 0, 50);
ZyphraxHub["c0"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["c0"]["ScrollBarThickness"] = 5;
ZyphraxHub["c0"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DropdownList.DropdownItemsSearch.UIListLayout
ZyphraxHub["c1"] = Instance.new("UIListLayout", ZyphraxHub["c0"]);
ZyphraxHub["c1"]["Padding"] = UDim.new(0, 15);
ZyphraxHub["c1"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DropdownList.DropdownItemsSearch.UIPadding
ZyphraxHub["c2"] = Instance.new("UIPadding", ZyphraxHub["c0"]);
ZyphraxHub["c2"]["PaddingTop"] = UDim.new(0, 2);
ZyphraxHub["c2"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["c2"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["c2"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DropdownButton
ZyphraxHub["c3"] = Instance.new("ImageButton", ZyphraxHub["41"]);
ZyphraxHub["c3"]["BorderSizePixel"] = 0;
ZyphraxHub["c3"]["AutoButtonColor"] = false;
ZyphraxHub["c3"]["Visible"] = false;
ZyphraxHub["c3"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["c3"]["Selectable"] = false;
ZyphraxHub["c3"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["c3"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["c3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["c3"]["Name"] = [[DropdownButton]];
ZyphraxHub["c3"]["Position"] = UDim2.new(0, 0, 0.384, 0);


-- ZyphraxHub.Templates.DropdownButton.UICorner
ZyphraxHub["c4"] = Instance.new("UICorner", ZyphraxHub["c3"]);
ZyphraxHub["c4"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.DropdownButton.Frame
ZyphraxHub["c5"] = Instance.new("Frame", ZyphraxHub["c3"]);
ZyphraxHub["c5"]["BorderSizePixel"] = 0;
ZyphraxHub["c5"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["c5"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["c5"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["c5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["c5"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DropdownButton.Frame.UIListLayout
ZyphraxHub["c6"] = Instance.new("UIListLayout", ZyphraxHub["c5"]);
ZyphraxHub["c6"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["c6"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DropdownButton.Frame.UIPadding
ZyphraxHub["c7"] = Instance.new("UIPadding", ZyphraxHub["c5"]);
ZyphraxHub["c7"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["c7"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["c7"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["c7"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DropdownButton.Frame.Title
ZyphraxHub["c8"] = Instance.new("TextLabel", ZyphraxHub["c5"]);
ZyphraxHub["c8"]["TextWrapped"] = true;
ZyphraxHub["c8"]["Interactable"] = false;
ZyphraxHub["c8"]["BorderSizePixel"] = 0;
ZyphraxHub["c8"]["TextSize"] = 16;
ZyphraxHub["c8"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["c8"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["c8"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["c8"]["BackgroundTransparency"] = 1;
ZyphraxHub["c8"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["c8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["c8"]["Text"] = [[Button]];
ZyphraxHub["c8"]["Name"] = [[Title]];


-- ZyphraxHub.Templates.DropdownButton.Frame.Description
ZyphraxHub["c9"] = Instance.new("TextLabel", ZyphraxHub["c5"]);
ZyphraxHub["c9"]["TextWrapped"] = true;
ZyphraxHub["c9"]["Interactable"] = false;
ZyphraxHub["c9"]["BorderSizePixel"] = 0;
ZyphraxHub["c9"]["TextSize"] = 16;
ZyphraxHub["c9"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["c9"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["c9"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["c9"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["c9"]["BackgroundTransparency"] = 1;
ZyphraxHub["c9"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["c9"]["Visible"] = false;
ZyphraxHub["c9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["c9"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["c9"]["LayoutOrder"] = 1;
ZyphraxHub["c9"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["c9"]["Name"] = [[Description]];


-- ZyphraxHub.Templates.DropdownButton.Frame.UIGradient
ZyphraxHub["ca"] = Instance.new("UIGradient", ZyphraxHub["c5"]);
ZyphraxHub["ca"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.DropdownButton.Frame.UIGradient
ZyphraxHub["cb"] = Instance.new("UIGradient", ZyphraxHub["c5"]);
ZyphraxHub["cb"]["Enabled"] = false;
ZyphraxHub["cb"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.DropdownButton.Frame.UIGradient
ZyphraxHub["cc"] = Instance.new("UIGradient", ZyphraxHub["c5"]);
ZyphraxHub["cc"]["Enabled"] = false;
ZyphraxHub["cc"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.DropdownButton.Frame.UICorner
ZyphraxHub["cd"] = Instance.new("UICorner", ZyphraxHub["c5"]);
ZyphraxHub["cd"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.DropdownButton.UIStroke
ZyphraxHub["ce"] = Instance.new("UIStroke", ZyphraxHub["c3"]);
ZyphraxHub["ce"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["ce"]["Thickness"] = 1.5;
ZyphraxHub["ce"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Code
ZyphraxHub["cf"] = Instance.new("Frame", ZyphraxHub["41"]);
ZyphraxHub["cf"]["Visible"] = false;
ZyphraxHub["cf"]["BorderSizePixel"] = 0;
ZyphraxHub["cf"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["cf"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["cf"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["cf"]["Position"] = UDim2.new(-0.0375, 0, 0.38434, 0);
ZyphraxHub["cf"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["cf"]["Name"] = [[Code]];


-- ZyphraxHub.Templates.Code.UICorner
ZyphraxHub["d0"] = Instance.new("UICorner", ZyphraxHub["cf"]);
ZyphraxHub["d0"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.Code.UIStroke
ZyphraxHub["d1"] = Instance.new("UIStroke", ZyphraxHub["cf"]);
ZyphraxHub["d1"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["d1"]["Thickness"] = 1.5;
ZyphraxHub["d1"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Code.Title
ZyphraxHub["d2"] = Instance.new("TextLabel", ZyphraxHub["cf"]);
ZyphraxHub["d2"]["TextWrapped"] = true;
ZyphraxHub["d2"]["Interactable"] = false;
ZyphraxHub["d2"]["BorderSizePixel"] = 0;
ZyphraxHub["d2"]["TextSize"] = 16;
ZyphraxHub["d2"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["d2"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["d2"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["d2"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["d2"]["BackgroundTransparency"] = 1;
ZyphraxHub["d2"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["d2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["d2"]["Text"] = [[Title]];
ZyphraxHub["d2"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["d2"]["Name"] = [[Title]];


-- ZyphraxHub.Templates.Code.UIPadding
ZyphraxHub["d3"] = Instance.new("UIPadding", ZyphraxHub["cf"]);
ZyphraxHub["d3"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["d3"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["d3"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["d3"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.Code.UIListLayout
ZyphraxHub["d4"] = Instance.new("UIListLayout", ZyphraxHub["cf"]);
ZyphraxHub["d4"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["d4"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Code.Code
ZyphraxHub["d5"] = Instance.new("TextBox", ZyphraxHub["cf"]);
ZyphraxHub["d5"]["Name"] = [[Code]];
ZyphraxHub["d5"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["d5"]["BorderSizePixel"] = 0;
ZyphraxHub["d5"]["TextEditable"] = false;
ZyphraxHub["d5"]["TextWrapped"] = true;
ZyphraxHub["d5"]["TextSize"] = 16;
ZyphraxHub["d5"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["d5"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["d5"]["FontFace"] = Font.new([[rbxasset://fonts/families/Inconsolata.json]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["d5"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["d5"]["Selectable"] = false;
ZyphraxHub["d5"]["MultiLine"] = true;
ZyphraxHub["d5"]["ClearTextOnFocus"] = false;
ZyphraxHub["d5"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["d5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["d5"]["Text"] = [[print("Hello World!")]];
ZyphraxHub["d5"]["LayoutOrder"] = 1;
ZyphraxHub["d5"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.Section
ZyphraxHub["d6"] = Instance.new("Frame", ZyphraxHub["41"]);
ZyphraxHub["d6"]["Visible"] = false;
ZyphraxHub["d6"]["BorderSizePixel"] = 0;
ZyphraxHub["d6"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["d6"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["d6"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["d6"]["Position"] = UDim2.new(0, 0, 0.43728, 0);
ZyphraxHub["d6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["d6"]["Name"] = [[Section]];
ZyphraxHub["d6"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert SelectionImageObject, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"


-- ZyphraxHub.Templates.Section.Button
ZyphraxHub["d7"] = Instance.new("ImageButton", ZyphraxHub["d6"]);
ZyphraxHub["d7"]["BorderSizePixel"] = 0;
ZyphraxHub["d7"]["AutoButtonColor"] = false;
ZyphraxHub["d7"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["d7"]["Selectable"] = false;
ZyphraxHub["d7"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["d7"]["Size"] = UDim2.new(1, 0, 0, 35);
ZyphraxHub["d7"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["d7"]["Name"] = [[Button]];


-- ZyphraxHub.Templates.Section.Button.UICorner
ZyphraxHub["d8"] = Instance.new("UICorner", ZyphraxHub["d7"]);
ZyphraxHub["d8"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.Section.Button.UIStroke
ZyphraxHub["d9"] = Instance.new("UIStroke", ZyphraxHub["d7"]);
ZyphraxHub["d9"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["d9"]["Thickness"] = 1.5;
ZyphraxHub["d9"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Section.Button.Title
ZyphraxHub["da"] = Instance.new("TextLabel", ZyphraxHub["d7"]);
ZyphraxHub["da"]["TextWrapped"] = true;
ZyphraxHub["da"]["Interactable"] = false;
ZyphraxHub["da"]["BorderSizePixel"] = 0;
ZyphraxHub["da"]["TextSize"] = 16;
ZyphraxHub["da"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["da"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["da"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["da"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["da"]["BackgroundTransparency"] = 1;
ZyphraxHub["da"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["da"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["da"]["Text"] = [[Section]];
ZyphraxHub["da"]["Name"] = [[Title]];


-- ZyphraxHub.Templates.Section.Button.Title.Arrow
ZyphraxHub["db"] = Instance.new("ImageButton", ZyphraxHub["da"]);
ZyphraxHub["db"]["BorderSizePixel"] = 0;
ZyphraxHub["db"]["AutoButtonColor"] = false;
ZyphraxHub["db"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["db"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["db"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["db"]["AnchorPoint"] = Vector2.new(1, 0.5);
ZyphraxHub["db"]["Image"] = [[rbxassetid://120292618616139]];
ZyphraxHub["db"]["Size"] = UDim2.new(0, 23, 0, 23);
ZyphraxHub["db"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["db"]["Name"] = [[Arrow]];
ZyphraxHub["db"]["Position"] = UDim2.new(1, 0, 0.5, 0);


-- ZyphraxHub.Templates.Section.Button.UIPadding
ZyphraxHub["dc"] = Instance.new("UIPadding", ZyphraxHub["d7"]);
ZyphraxHub["dc"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["dc"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["dc"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["dc"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.Section.Button.UIListLayout
ZyphraxHub["dd"] = Instance.new("UIListLayout", ZyphraxHub["d7"]);
ZyphraxHub["dd"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["dd"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Section.Button.Description
ZyphraxHub["de"] = Instance.new("TextLabel", ZyphraxHub["d7"]);
ZyphraxHub["de"]["TextWrapped"] = true;
ZyphraxHub["de"]["Interactable"] = false;
ZyphraxHub["de"]["BorderSizePixel"] = 0;
ZyphraxHub["de"]["TextSize"] = 16;
ZyphraxHub["de"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["de"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["de"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Medium, Enum.FontStyle.Normal);
ZyphraxHub["de"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["de"]["BackgroundTransparency"] = 1;
ZyphraxHub["de"]["Size"] = UDim2.new(1, 0, 0, 15);
ZyphraxHub["de"]["Visible"] = false;
ZyphraxHub["de"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["de"]["Text"] = [[Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus placerat lacus in enim congue, fermentum euismod leo ultricies. Nulla sodales. ]];
ZyphraxHub["de"]["LayoutOrder"] = 1;
ZyphraxHub["de"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["de"]["Name"] = [[Description]];


-- ZyphraxHub.Templates.Section.Button.UIGradient
ZyphraxHub["df"] = Instance.new("UIGradient", ZyphraxHub["d7"]);
ZyphraxHub["df"]["Enabled"] = false;
ZyphraxHub["df"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Section.Button.UIGradient
ZyphraxHub["e0"] = Instance.new("UIGradient", ZyphraxHub["d7"]);
ZyphraxHub["e0"]["Enabled"] = false;
ZyphraxHub["e0"]["Transparency"] = NumberSequence.new{NumberSequenceKeypoint.new(0.000, 1),NumberSequenceKeypoint.new(1.000, 1)};
ZyphraxHub["e0"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Section.Button.UIGradient
ZyphraxHub["e1"] = Instance.new("UIGradient", ZyphraxHub["d7"]);
ZyphraxHub["e1"]["Enabled"] = false;
ZyphraxHub["e1"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(124, 58, 237)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(192, 132, 252)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(124, 58, 237))};


-- ZyphraxHub.Templates.Section.Button.UIStroke
ZyphraxHub["e2"] = Instance.new("UIStroke", ZyphraxHub["d7"]);
ZyphraxHub["e2"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["e2"]["Thickness"] = 1.5;
ZyphraxHub["e2"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.Section.Frame
ZyphraxHub["e3"] = Instance.new("Frame", ZyphraxHub["d6"]);
ZyphraxHub["e3"]["Visible"] = false;
ZyphraxHub["e3"]["BorderSizePixel"] = 0;
ZyphraxHub["e3"]["BackgroundColor3"] = Color3.fromRGB(192, 132, 252);
ZyphraxHub["e3"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["e3"]["Size"] = UDim2.new(1, 0, 0, 30);
ZyphraxHub["e3"]["Position"] = UDim2.new(0, 0, 0, 35);
ZyphraxHub["e3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["e3"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.Section.Frame.UIListLayout
ZyphraxHub["e4"] = Instance.new("UIListLayout", ZyphraxHub["e3"]);
ZyphraxHub["e4"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
ZyphraxHub["e4"]["Padding"] = UDim.new(0, 10);
ZyphraxHub["e4"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.Section.Frame.UIPadding
ZyphraxHub["e5"] = Instance.new("UIPadding", ZyphraxHub["e3"]);
ZyphraxHub["e5"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["e5"]["PaddingRight"] = UDim.new(0, 8);
ZyphraxHub["e5"]["PaddingLeft"] = UDim.new(0, 8);


-- ZyphraxHub.Templates.Section.Frame.Divider
ZyphraxHub["e6"] = Instance.new("Frame", ZyphraxHub["e3"]);
ZyphraxHub["e6"]["BorderSizePixel"] = 0;
ZyphraxHub["e6"]["BackgroundColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["e6"]["Size"] = UDim2.new(1, 0, 0, 3);
ZyphraxHub["e6"]["BorderColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["e6"]["Name"] = [[Divider]];


-- ZyphraxHub.Templates.DialogElements
ZyphraxHub["e7"] = Instance.new("Folder", ZyphraxHub["41"]);
ZyphraxHub["e7"]["Name"] = [[DialogElements]];


-- ZyphraxHub.Templates.DialogElements.DarkOverlayDialog
ZyphraxHub["e8"] = Instance.new("Frame", ZyphraxHub["e7"]);
ZyphraxHub["e8"]["Visible"] = false;
ZyphraxHub["e8"]["BorderSizePixel"] = 0;
ZyphraxHub["e8"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["e8"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["e8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["e8"]["Name"] = [[DarkOverlayDialog]];
ZyphraxHub["e8"]["BackgroundTransparency"] = 0.6;


-- ZyphraxHub.Templates.DialogElements.DarkOverlayDialog.UICorner
ZyphraxHub["e9"] = Instance.new("UICorner", ZyphraxHub["e8"]);
ZyphraxHub["e9"]["CornerRadius"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DialogElements.Dialog
ZyphraxHub["ea"] = Instance.new("Frame", ZyphraxHub["e7"]);
ZyphraxHub["ea"]["Visible"] = false;
ZyphraxHub["ea"]["ZIndex"] = 4;
ZyphraxHub["ea"]["BorderSizePixel"] = 0;
ZyphraxHub["ea"]["BackgroundColor3"] = Color3.fromRGB(32, 35, 41);
ZyphraxHub["ea"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["ea"]["ClipsDescendants"] = true;
ZyphraxHub["ea"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["ea"]["Size"] = UDim2.new(0, 250, 0, 0);
ZyphraxHub["ea"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);
ZyphraxHub["ea"]["BorderColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["ea"]["Name"] = [[Dialog]];


-- ZyphraxHub.Templates.DialogElements.Dialog.UICorner
ZyphraxHub["eb"] = Instance.new("UICorner", ZyphraxHub["ea"]);
ZyphraxHub["eb"]["CornerRadius"] = UDim.new(0, 6);


-- ZyphraxHub.Templates.DialogElements.Dialog.UIStroke
ZyphraxHub["ec"] = Instance.new("UIStroke", ZyphraxHub["ea"]);
ZyphraxHub["ec"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["ec"]["Thickness"] = 1.5;
ZyphraxHub["ec"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.DialogElements.Dialog.Title
ZyphraxHub["ed"] = Instance.new("Frame", ZyphraxHub["ea"]);
ZyphraxHub["ed"]["BorderSizePixel"] = 0;
ZyphraxHub["ed"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["ed"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["ed"]["Size"] = UDim2.new(1, 0, 0, 25);
ZyphraxHub["ed"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["ed"]["Name"] = [[Title]];
ZyphraxHub["ed"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DialogElements.Dialog.Title.TextLabel
ZyphraxHub["ee"] = Instance.new("TextLabel", ZyphraxHub["ed"]);
ZyphraxHub["ee"]["Interactable"] = false;
ZyphraxHub["ee"]["ZIndex"] = 0;
ZyphraxHub["ee"]["BorderSizePixel"] = 0;
ZyphraxHub["ee"]["TextSize"] = 20;
ZyphraxHub["ee"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["ee"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["ee"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["ee"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["ee"]["BackgroundTransparency"] = 1;
ZyphraxHub["ee"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["ee"]["Size"] = UDim2.new(0, 0, 0, 20);
ZyphraxHub["ee"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["ee"]["Text"] = [[]];
ZyphraxHub["ee"]["LayoutOrder"] = 1;
ZyphraxHub["ee"]["AutomaticSize"] = Enum.AutomaticSize.XY;
ZyphraxHub["ee"]["Position"] = UDim2.new(-0.05455, 12, 0.5, 0);


-- ZyphraxHub.Templates.DialogElements.Dialog.Title.UIListLayout
ZyphraxHub["ef"] = Instance.new("UIListLayout", ZyphraxHub["ed"]);
ZyphraxHub["ef"]["Padding"] = UDim.new(0, 10);
ZyphraxHub["ef"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["ef"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
ZyphraxHub["ef"]["FillDirection"] = Enum.FillDirection.Horizontal;


-- ZyphraxHub.Templates.DialogElements.Dialog.Title.UIPadding
ZyphraxHub["f0"] = Instance.new("UIPadding", ZyphraxHub["ed"]);
ZyphraxHub["f0"]["PaddingTop"] = UDim.new(0, 5);
ZyphraxHub["f0"]["PaddingRight"] = UDim.new(0, 15);
ZyphraxHub["f0"]["PaddingLeft"] = UDim.new(0, 15);
ZyphraxHub["f0"]["PaddingBottom"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.DialogElements.Dialog.Title.Icon
ZyphraxHub["f1"] = Instance.new("ImageButton", ZyphraxHub["ed"]);
ZyphraxHub["f1"]["BorderSizePixel"] = 0;
ZyphraxHub["f1"]["Visible"] = false;
ZyphraxHub["f1"]["BackgroundTransparency"] = 1;
ZyphraxHub["f1"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["f1"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["f1"]["Size"] = UDim2.new(0, 33, 0, 25);
ZyphraxHub["f1"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["f1"]["Name"] = [[Icon]];
ZyphraxHub["f1"]["Position"] = UDim2.new(0, 0, 0.2125, 0);


-- ZyphraxHub.Templates.DialogElements.Dialog.Title.Icon.UIAspectRatioConstraint
ZyphraxHub["f2"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["f1"]);



-- ZyphraxHub.Templates.DialogElements.Dialog.UIListLayout
ZyphraxHub["f3"] = Instance.new("UIListLayout", ZyphraxHub["ea"]);
ZyphraxHub["f3"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
ZyphraxHub["f3"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DialogElements.Dialog.Content
ZyphraxHub["f4"] = Instance.new("Frame", ZyphraxHub["ea"]);
ZyphraxHub["f4"]["Visible"] = false;
ZyphraxHub["f4"]["ZIndex"] = 2;
ZyphraxHub["f4"]["BorderSizePixel"] = 0;
ZyphraxHub["f4"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["f4"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["f4"]["Size"] = UDim2.new(1, 0, 0, 0);
ZyphraxHub["f4"]["Position"] = UDim2.new(0, 0, 0.21886, 0);
ZyphraxHub["f4"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["f4"]["Name"] = [[Content]];
ZyphraxHub["f4"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DialogElements.Dialog.Content.UIListLayout
ZyphraxHub["f5"] = Instance.new("UIListLayout", ZyphraxHub["f4"]);
ZyphraxHub["f5"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["f5"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DialogElements.Dialog.Content.UIPadding
ZyphraxHub["f6"] = Instance.new("UIPadding", ZyphraxHub["f4"]);
ZyphraxHub["f6"]["PaddingTop"] = UDim.new(0, 5);
ZyphraxHub["f6"]["PaddingRight"] = UDim.new(0, 15);
ZyphraxHub["f6"]["PaddingLeft"] = UDim.new(0, 15);
ZyphraxHub["f6"]["PaddingBottom"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.DialogElements.Dialog.Content.TextLabel
ZyphraxHub["f7"] = Instance.new("TextLabel", ZyphraxHub["f4"]);
ZyphraxHub["f7"]["TextWrapped"] = true;
ZyphraxHub["f7"]["Interactable"] = false;
ZyphraxHub["f7"]["BorderSizePixel"] = 0;
ZyphraxHub["f7"]["TextSize"] = 15;
ZyphraxHub["f7"]["TextXAlignment"] = Enum.TextXAlignment.Left;
ZyphraxHub["f7"]["TextYAlignment"] = Enum.TextYAlignment.Top;
ZyphraxHub["f7"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["f7"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["f7"]["TextColor3"] = Color3.fromRGB(145, 154, 173);
ZyphraxHub["f7"]["BackgroundTransparency"] = 1;
ZyphraxHub["f7"]["Size"] = UDim2.new(1, 0, 0, 0);
ZyphraxHub["f7"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["f7"]["Text"] = [[]];
ZyphraxHub["f7"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["f7"]["Position"] = UDim2.new(0, 0, 0.125, 0);


-- ZyphraxHub.Templates.DialogElements.Dialog.UIPadding
ZyphraxHub["f8"] = Instance.new("UIPadding", ZyphraxHub["ea"]);
ZyphraxHub["f8"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["f8"]["PaddingBottom"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DialogElements.Dialog.Buttons
ZyphraxHub["f9"] = Instance.new("Frame", ZyphraxHub["ea"]);
ZyphraxHub["f9"]["ZIndex"] = 3;
ZyphraxHub["f9"]["BorderSizePixel"] = 0;
ZyphraxHub["f9"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["f9"]["AutomaticSize"] = Enum.AutomaticSize.Y;
ZyphraxHub["f9"]["Size"] = UDim2.new(1, 0, 0, 0);
ZyphraxHub["f9"]["Position"] = UDim2.new(0, 0, 0.53017, 0);
ZyphraxHub["f9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["f9"]["Name"] = [[Buttons]];
ZyphraxHub["f9"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DialogElements.Dialog.Buttons.UIListLayout
ZyphraxHub["fa"] = Instance.new("UIListLayout", ZyphraxHub["f9"]);
ZyphraxHub["fa"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
ZyphraxHub["fa"]["Padding"] = UDim.new(0, 10);
ZyphraxHub["fa"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DialogElements.Dialog.Buttons.UIPadding
ZyphraxHub["fb"] = Instance.new("UIPadding", ZyphraxHub["f9"]);
ZyphraxHub["fb"]["PaddingTop"] = UDim.new(0, 5);
ZyphraxHub["fb"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["fb"]["PaddingLeft"] = UDim.new(0, 10);


-- ZyphraxHub.Templates.DialogElements.DialogButton
ZyphraxHub["fc"] = Instance.new("Frame", ZyphraxHub["e7"]);
ZyphraxHub["fc"]["Visible"] = false;
ZyphraxHub["fc"]["BorderSizePixel"] = 0;
ZyphraxHub["fc"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["fc"]["AnchorPoint"] = Vector2.new(0.5, 1);
ZyphraxHub["fc"]["Size"] = UDim2.new(1, 0, 0, 30);
ZyphraxHub["fc"]["Position"] = UDim2.new(0.5, 0, 0.327, 0);
ZyphraxHub["fc"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["fc"]["Name"] = [[DialogButton]];
ZyphraxHub["fc"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.Templates.DialogElements.DialogButton.Button
ZyphraxHub["fd"] = Instance.new("TextButton", ZyphraxHub["fc"]);
ZyphraxHub["fd"]["BorderSizePixel"] = 0;
ZyphraxHub["fd"]["AutoButtonColor"] = false;
ZyphraxHub["fd"]["BackgroundColor3"] = Color3.fromRGB(43, 46, 53);
ZyphraxHub["fd"]["Selectable"] = false;
ZyphraxHub["fd"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["fd"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["fd"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["fd"]["Name"] = [[Button]];
ZyphraxHub["fd"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);


-- ZyphraxHub.Templates.DialogElements.DialogButton.Button.UICorner
ZyphraxHub["fe"] = Instance.new("UICorner", ZyphraxHub["fd"]);
ZyphraxHub["fe"]["CornerRadius"] = UDim.new(0, 5);


-- ZyphraxHub.Templates.DialogElements.DialogButton.Button.UIStroke
ZyphraxHub["ff"] = Instance.new("UIStroke", ZyphraxHub["fd"]);
ZyphraxHub["ff"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["ff"]["Thickness"] = 1.5;
ZyphraxHub["ff"]["Color"] = Color3.fromRGB(61, 61, 75);


-- ZyphraxHub.Templates.DialogElements.DialogButton.Button.UIListLayout
ZyphraxHub["100"] = Instance.new("UIListLayout", ZyphraxHub["fd"]);
ZyphraxHub["100"]["HorizontalAlignment"] = Enum.HorizontalAlignment.Center;
ZyphraxHub["100"]["Padding"] = UDim.new(0, 5);
ZyphraxHub["100"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["100"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.Templates.DialogElements.DialogButton.Button.Label
ZyphraxHub["101"] = Instance.new("TextLabel", ZyphraxHub["fd"]);
ZyphraxHub["101"]["TextWrapped"] = true;
ZyphraxHub["101"]["Interactable"] = false;
ZyphraxHub["101"]["BorderSizePixel"] = 0;
ZyphraxHub["101"]["TextSize"] = 14;
ZyphraxHub["101"]["TextScaled"] = true;
ZyphraxHub["101"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["101"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
ZyphraxHub["101"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["101"]["BackgroundTransparency"] = 1;
ZyphraxHub["101"]["Size"] = UDim2.new(1, 0, 0.45, 0);
ZyphraxHub["101"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["101"]["Text"] = [[]];
ZyphraxHub["101"]["Name"] = [[Label]];
ZyphraxHub["101"]["Position"] = UDim2.new(0, 45, 0.083, 0);


-- ZyphraxHub.NotificationList
ZyphraxHub["102"] = Instance.new("Frame", ZyphraxHub["1"]);
ZyphraxHub["102"]["ZIndex"] = 10;
ZyphraxHub["102"]["BorderSizePixel"] = 0;
ZyphraxHub["102"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["102"]["AnchorPoint"] = Vector2.new(0.5, 0);
ZyphraxHub["102"]["Size"] = UDim2.new(0, 630, 1, 0);
ZyphraxHub["102"]["Position"] = UDim2.new(1, 0, 0, 0);
ZyphraxHub["102"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["102"]["Name"] = [[NotificationList]];
ZyphraxHub["102"]["BackgroundTransparency"] = 1;


-- ZyphraxHub.NotificationList.UIListLayout
ZyphraxHub["103"] = Instance.new("UIListLayout", ZyphraxHub["102"]);
ZyphraxHub["103"]["Padding"] = UDim.new(0, 12);
ZyphraxHub["103"]["SortOrder"] = Enum.SortOrder.LayoutOrder;


-- ZyphraxHub.NotificationList.UIPadding
ZyphraxHub["104"] = Instance.new("UIPadding", ZyphraxHub["102"]);
ZyphraxHub["104"]["PaddingTop"] = UDim.new(0, 10);
ZyphraxHub["104"]["PaddingRight"] = UDim.new(0, 40);
ZyphraxHub["104"]["PaddingLeft"] = UDim.new(0, 40);


-- ZyphraxHub.FloatIcon
ZyphraxHub["105"] = Instance.new("Frame", ZyphraxHub["1"]);
ZyphraxHub["105"]["Visible"] = false;
ZyphraxHub["105"]["ZIndex"] = 0;
ZyphraxHub["105"]["BorderSizePixel"] = 2;
ZyphraxHub["105"]["BackgroundColor3"] = Color3.fromRGB(37, 40, 47);
ZyphraxHub["105"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["105"]["ClipsDescendants"] = true;
ZyphraxHub["105"]["AutomaticSize"] = Enum.AutomaticSize.X;
ZyphraxHub["105"]["Size"] = UDim2.new(0, 85, 0, 45);
ZyphraxHub["105"]["Position"] = UDim2.new(0.5, 0, 0, 45);
ZyphraxHub["105"]["BorderColor3"] = Color3.fromRGB(61, 61, 75);
ZyphraxHub["105"]["Name"] = [[FloatIcon]];


-- ZyphraxHub.FloatIcon.UICorner
ZyphraxHub["106"] = Instance.new("UICorner", ZyphraxHub["105"]);
ZyphraxHub["106"]["CornerRadius"] = UDim.new(0, 10);


-- ZyphraxHub.FloatIcon.UIStroke
ZyphraxHub["107"] = Instance.new("UIStroke", ZyphraxHub["105"]);
ZyphraxHub["107"]["Transparency"] = 0.5;
ZyphraxHub["107"]["ApplyStrokeMode"] = Enum.ApplyStrokeMode.Border;
ZyphraxHub["107"]["Thickness"] = 1.5;
ZyphraxHub["107"]["Color"] = Color3.fromRGB(95, 95, 117);


-- ZyphraxHub.FloatIcon.UIPadding
ZyphraxHub["108"] = Instance.new("UIPadding", ZyphraxHub["105"]);
ZyphraxHub["108"]["PaddingTop"] = UDim.new(0, 8);
ZyphraxHub["108"]["PaddingRight"] = UDim.new(0, 10);
ZyphraxHub["108"]["PaddingLeft"] = UDim.new(0, 10);
ZyphraxHub["108"]["PaddingBottom"] = UDim.new(0, 8);


-- ZyphraxHub.FloatIcon.UIListLayout
ZyphraxHub["109"] = Instance.new("UIListLayout", ZyphraxHub["105"]);
ZyphraxHub["109"]["Padding"] = UDim.new(0, 8);
ZyphraxHub["109"]["VerticalAlignment"] = Enum.VerticalAlignment.Center;
ZyphraxHub["109"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
ZyphraxHub["109"]["FillDirection"] = Enum.FillDirection.Horizontal;


-- ZyphraxHub.FloatIcon.Icon
ZyphraxHub["10a"] = Instance.new("ImageButton", ZyphraxHub["105"]);
ZyphraxHub["10a"]["Active"] = false;
ZyphraxHub["10a"]["Interactable"] = false;
ZyphraxHub["10a"]["BorderSizePixel"] = 0;
ZyphraxHub["10a"]["AutoButtonColor"] = false;
ZyphraxHub["10a"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["10a"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["10a"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["10a"]["Image"] = [[rbxassetid://113216930555884]];
ZyphraxHub["10a"]["Size"] = UDim2.new(1, 0, 1, 0);
ZyphraxHub["10a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["10a"]["Name"] = [[Icon]];
ZyphraxHub["10a"]["Position"] = UDim2.new(0, 10, 0.5, 0);


-- ZyphraxHub.FloatIcon.Icon.UIAspectRatioConstraint
ZyphraxHub["10b"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["10a"]);



-- ZyphraxHub.FloatIcon.TextLabel
ZyphraxHub["10c"] = Instance.new("TextLabel", ZyphraxHub["105"]);
ZyphraxHub["10c"]["Interactable"] = false;
ZyphraxHub["10c"]["BorderSizePixel"] = 0;
ZyphraxHub["10c"]["TextSize"] = 16;
ZyphraxHub["10c"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["10c"]["FontFace"] = Font.new([[rbxassetid://11702779517]], Enum.FontWeight.SemiBold, Enum.FontStyle.Normal);
ZyphraxHub["10c"]["TextColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["10c"]["BackgroundTransparency"] = 1;
ZyphraxHub["10c"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
ZyphraxHub["10c"]["Size"] = UDim2.new(0, 20, 0, 20);
ZyphraxHub["10c"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["10c"]["Text"] = [[ZyphraxHub]];
ZyphraxHub["10c"]["AutomaticSize"] = Enum.AutomaticSize.X;
ZyphraxHub["10c"]["Position"] = UDim2.new(0.38615, 0, 0.53448, -1);


-- ZyphraxHub.FloatIcon.Open
ZyphraxHub["10d"] = Instance.new("ImageButton", ZyphraxHub["105"]);
ZyphraxHub["10d"]["BorderSizePixel"] = 0;
ZyphraxHub["10d"]["AutoButtonColor"] = false;
ZyphraxHub["10d"]["BackgroundTransparency"] = 1;
-- [ERROR] cannot convert ImageContent, please report to "https://github.com/uniquadev/GuiToLuaConverter/issues"
ZyphraxHub["10d"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
ZyphraxHub["10d"]["ImageColor3"] = Color3.fromRGB(197, 204, 219);
ZyphraxHub["10d"]["Selectable"] = false;
ZyphraxHub["10d"]["AnchorPoint"] = Vector2.new(0, 0.5);
ZyphraxHub["10d"]["Image"] = [[rbxassetid://122219713887461]];
ZyphraxHub["10d"]["Size"] = UDim2.new(0, 20, 0, 20);
ZyphraxHub["10d"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
ZyphraxHub["10d"]["Name"] = [[Open]];
ZyphraxHub["10d"]["Position"] = UDim2.new(0, 128, 0.5, 0);


-- ZyphraxHub.FloatIcon.Open.UIAspectRatioConstraint
ZyphraxHub["10e"] = Instance.new("UIAspectRatioConstraint", ZyphraxHub["10d"]);



-- ZyphraxHub.FloatIcon.Open.UICorner
ZyphraxHub["10f"] = Instance.new("UICorner", ZyphraxHub["10d"]);



-- Require ZyphraxHub wrapper
local ZyphraxHub_REQUIRE = require;
local ZyphraxHub_MODULES = {};
local function require(Module:ModuleScript)
	local ModuleState = ZyphraxHub_MODULES[Module];
	if ModuleState then
	...
	return ZyphraxHub_REQUIRE(Module);
end

ZyphraxHub_MODULES[ZyphraxHub["3e"]] = {
	Closure = function()
		local script = ZyphraxHub["3e"];local LIB = {}
...
ZyphraxHub_MODULES[ZyphraxHub["3f"]] = {
	Closure = function()
		local script = ZyphraxHub["3f"];
...
ZyphraxHub_MODULES[ZyphraxHub["40"]] = {
	Closure = function()
		local script = ZyphraxHub["40"];-- Generated by .ftgs 
