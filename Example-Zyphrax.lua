...
local ZyphraxHub = game:HttpGet("https://raw.githubusercontent.com/create-stree/VFmkY17j/refs/heads/main/ui.lua")
...
local Tabs = {
	...
	DropdownTab = Window:Tab({ Title = "Dropdown", Icon = "chevron-down", Desc = "Select from multiple options." }),
	b = Window:Divider(),
