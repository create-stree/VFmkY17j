...
StreeHub["54"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 130, 20)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(0, 130, 20)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(57, 255, 20))};


-- StreeHub.Templates.Button.Frame.UIGradient
StreeHub["55"] = Instance.new("UIGradient", StreeHub["4e"]);
StreeHub["55"]["Enabled"] = false;
StreeHub["55"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(120, 255, 50)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(0, 130, 20)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(120, 255, 50)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(57, 255, 20))};


-- StreeHub.Templates.Button.Frame.UIGradient
StreeHub["56"] = Instance.new("UIGradient", StreeHub["4e"]);
StreeHub["56"]["Enabled"] = false;
StreeHub["56"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.160, Color3.fromRGB(0, 130, 20)),ColorSequenceKeypoint.new(0.320, Color3.fromRGB(57, 255, 20)),ColorSequenceKeypoint.new(0.540, Color3.fromRGB(120, 255, 50)),ColorSequenceKeypoint.new(0.782, Color3.fromRGB(0, 130, 20)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(57, 255, 20))};
...
StreeHub["73"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 140, 20)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(57, 255, 20))};
...
StreeHub["7b"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(0, 140, 20)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(57, 255, 20))};
...
StreeHub["93"]["Color"] = Color3.fromRGB(0, 180, 40);
...
StreeHub["e3"]["BackgroundColor3"] = Color3.fromRGB(180, 255, 200);
		...
		function LIB:CreateWindow(data)
				...
				function Tab:Button(data)
					...
					newButton.MouseEnter:Connect(function()
						if not ButtonData.Locked then
							Tween(newButton.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Toggle(data)
					...
					newToggle.Title.Fill.MouseEnter:Connect(function()
						if not Toggle.Locked then
							Tween(newToggle.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Slider(data)
					...
					Trigger.MouseEnter:Connect(function()
						...
						if not Slider.Locked then
							Tween(newSlider.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Input(data)
					...
					newInput.BoxFrame.Frame.TextBox.MouseEnter:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						end
					end)
					...
					newInput.BoxFrame.Frame.TextBox.Focused:Connect(function()
						if not Input.Locked then
							Tween(newInput.UIStroke, {Color = Color3.fromRGB(60, 60, 74)}, TweenConfigs.Global)
							Tween(newInput.BoxFrame.Frame.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						end
					end)
				...
				function Tab:Dropdown(data)
					...
					local function SelectValue(multi, newvalue)
						if not multi then
							...
							Tween(targetButton.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
							...
							Tween(targetbuttonSearch.UIStroke, {Color = Color3.fromRGB(0, 180, 40)}, TweenConfigs.Global)
						...
						if not Dropdown.Multi then
							...
							for _, buttonName in buttonList do
								...
								if selected == buttonName then
									...
									newDropdownButton.UIStroke.Color = Color3.fromRGB(0, 180, 40)
									...
									newDropdownButtonSearch.UIStroke.Color = Color3.fromRGB(0, 180, 40)
			...
			function Window:Dialog(data)
				...
				for _, button in Dialog.Buttons do
					...
					local buttonFrame = newButton:FindFirstChild("Button") or newButton:WaitForChild("Button", 3)
					local originalSize = buttonFrame.Size

					buttonFrame.Label.Text = buttonData.Title
					...
					buttonFrame.MouseButton1Down:Connect(function()
						Tween(buttonFrame, {Size = originalSize - Dialog.PressDecreaseSize}, TweenConfigs.Global)
					end)

					buttonFrame.MouseButton1Up:Connect(function()
						Tween(buttonFrame, {Size = originalSize}, TweenConfigs.Global)
					end)
